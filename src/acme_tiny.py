# This script is written by Daniel Roesler and can be found at this repository `https://github.com/diafygi/acme-tiny`
# The purpose of using this opensource, simple, vetted script is to renew letsencrypt certificate without using the letsencrypt client
#
#!/usr/bin/env python
